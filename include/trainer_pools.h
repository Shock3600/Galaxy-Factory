...
enum PoolTags {
    ...
    POOL_TAG_ROCKS = 5,
    POOL_TAG_SPEED = 6,
    POOL_TAG_DRACOCHECK = 7,
    POOL_TAG_OGRECHECK = 8,
    POOL_TAG_DONCHECK = 9,
...
#define MON_POOL_TAG_ROCKS          1 << POOL_TAG_ROCKS
#define MON_POOL_TAG_SPEED          1 << POOL_TAG_SPEED
#define MON_POOL_TAG_DRACOCHECK     1 << POOL_TAG_DRACOCHECK
#define MON_POOL_TAG_OGRECHECK      1 << POOL_TAG_OGRECHECK
#define MON_POOL_TAG_DONCHECK       1 << POOL_TAG_DONCHECK
