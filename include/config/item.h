...
#define I_KEY_ESCAPE_ROPE               GEN_4  // In Gen8, Escape Rope became a Key Item. Keep in mind, this will make it free to buy in marts.
...
#define I_FISHING_STICKY_BOOST     GEN_4 // In Gen 3, a Pokemon with Suction Cups or Sticky Hold in the first slot of the party causes the chance for a bite to increase by about 35%. In Gen 4 onwards, it doubles the base bite chance.
